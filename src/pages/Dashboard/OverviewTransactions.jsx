...
import {
  ...
  ChevronLeft,
  ChevronRight,
} from "lucide-react"; // Tambah Chevron
    ...
    <div className="w-full h-full flex flex-col justify-between">
      ...
      <div>
        <div className="flex justify-between items-center mb-4">
          ...
          <span className="text-sm text-text-black dark:text-text-white bg-text-grey-dark dark:bg-text-grey px-3 py-1 rounded-full">
          ...
          {transactions.length === 0 ? (
            ...
            currentTransactions.map((tx) => (
              <div
                ...
                className="flex items-center justify-between p-3 bg-text-white dark:bg-background-dark border border-gray-100 rounded-xl shadow-sm hover:shadow-md transition-shadow"
              >
                {/* KIRI */}
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-text-black dark:text-text-white text-sm">
                      {tx.category_name}
                    </h4>
          ...
          <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
            <div
              className={`p-6 text-white ${
                selectedTx.type === "income" ? "bg-green-500" : "bg-red-500"
              }`}
            >
